<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ManageRole.aspx.cs" Inherits="AdvancePOS.User.ManageRole" %>
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    <button type="button" class="btn margin btn-success btn-sm" data-toggle="modal" data-target="#edit">Add New Role</button>
                                    ...
                                    <asp:GridView ID="gvRole" runat="server" CssClass="table table-bordered table-striped"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">
                                ...
                                <asp:Literal ID="ltrTitle" runat="server" Text="Add Role" /></h4>
                        </div>
                        <div class="modal-body">
                            <ul class="nav nav-tabs">
                                <li class="active"><a data-toggle="tab" href="#user">Role Properties</a></li>
                            ...
                            <div class="tab-content">
                                                ...
                                                <div class="form-group">
                                                    <label for="role">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtName"
                                                            ForeColor="Red" ValidationGroup="role" SetFocusOnError="true" ErrorMessage="This field is require !!!"></asp:RequiredFieldValidator></label>
                                ...
                                <div id="roles" class="tab-pane fade">
                                    <div class="box-body">
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12">
                                                <asp:CheckBoxList ID="CheckBoxListModule" RepeatColumns="1" runat="server" Width="100%">
                                                </asp:CheckBoxList>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <asp:Button ID="btnSave" runat="server" Text="Save Changes" CssClass="btn btn-primary"
                                ValidationGroup="role" OnClick="btnSave_Click" />
                        </div>
                    </div>
                </ContentTemplate>
                <Triggers>
